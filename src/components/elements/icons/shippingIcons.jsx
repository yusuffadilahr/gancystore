...
const ShippingIcons = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className='w-5 text-white mr-1' viewBox="0 0 24 24" color="#000000" fill="none">
